...
from command_log.utils.signals import MODEL_SIGNALS, disable_signals
...
class LoggedCommand(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument(
            "--disable-model-signals",
            action="store_true",
            help="Disable all model signals while running this command.",
        )
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        disabled_signals = MODEL_SIGNALS if options["disable_model_signals"] else ()

        # Note: we're creating this log while signals are still enabled:
        # --disable-model-signals should only disable signals that execute during the
        # do_command method and not those generated by ManagementCommandLog.
